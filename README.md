...
The artifact includes `youtube_publishing_package.md`, `youtube_metadata.json`, `youtube_description.txt`, `hashtags.txt`, and `keywords.txt`. You can copy the generated title and description into YouTube Studio without manually writing the publishing text.
