...
The repository now includes a graphics-first long-form builder driven by [`project.yml`](project.yml) and a manually triggered GitHub Actions workflow at [`.github/workflows/generate-longform.yml`](.github/workflows/generate-longform.yml). It is designed for English science explainers and educational stories in **16:9 at 1920×1080 or higher**, using a staged shot pipeline: research/script planning, scene-level visual direction, optional free AI illustration assets, procedural diagrams, animation beats, typography, music, SFX, and final compositing. It does not depend on human footage.
